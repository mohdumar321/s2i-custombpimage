...
# openshift/php-56-centos7
FROM  ubuntu:14.04.4

# TODO: Put the maintainer name in the image metadata
MAINTAINER atos <your@email.com>
...
LABEL io.k8s.description="Platform for building php-5.6,nginx,orci8,instantclient" \
      io.k8s.display-name="builder php5.6.nginx.oci8" \
      io.openshift.expose-services="8080:http" \
      io.openshift.tags="builder,php-5.6,nginx,orci8,instantclient."
